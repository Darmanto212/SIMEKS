    ...
    <div class="container position-relative z-2">
        <div class="row justify-content-center">
            <div class="col-lg-10 hero-content">
                ...
                <div class="d-flex flex-column align-items-center gap-3 animate__animated animate__fadeInUp animate__delay-1s">
                    <a href="login.php" class="btn btn-maroon btn-lg shadow-lg border-white px-5 rounded-pill">Daftar Sekarang</a>
                    <a href="#ekskul" class="btn btn-glass-light px-4 rounded-pill">Lihat Ekskul</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-3">
        <div class="row align-items-center" data-aos="fade-right">
            ...
            <div class="col-lg-6 ps-lg-5" data-aos="fade-left">
                <h6 class="text-maroon fw-bold text-uppercase extra-small">Kenapa Memilih Kami?</h6>
                <h3 class="fw-bold mb-3">Mengembangkan Potensi, <br>Membangun Masa Depan.</h3>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <div class="bg-white p-2 rounded-circle shadow text-maroon me-3"><i class="fas fa-laptop-code"></i></div>
                            <span class="fw-bold text-dark">Sistem Digital</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <div class="bg-white p-2 rounded-circle shadow text-maroon me-3"><i class="fas fa-user-clock"></i></div>
                            <span class="fw-bold text-dark">Real-time Info</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <div class="bg-white p-2 rounded-circle shadow text-maroon me-3"><i class="fas fa-shield-alt"></i></div>
                            <span class="fw-bold text-dark">Data Aman</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <div class="bg-white p-2 rounded-circle shadow text-maroon me-3"><i class="fas fa-medal"></i></div>
                            <span class="fw-bold text-dark">Fokus Prestasi</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center mb-5" data-aos="fade-up">
            <div class="col-lg-8 text-center">
                <div class="section-title">
                    <h5 class="text-maroon fw-bold text-uppercase mb-2">Daftar Ekstrakurikuler</h5>
                    <h2 class="mb-0">Pilih Bakat dan Minatmu</h2>
                </div>
            </div>
        </div>
...
<section id="prestasi" class="py-5 bg-light-section overflow-hidden">
    <div class="container py-4">
        <div class="row justify-content-center mb-5" data-aos="fade-up">
            <div class="col-lg-8 text-center">
                <div class="section-title">
                    <h5 class="text-maroon fw-bold text-uppercase mb-2">Prestasi Terbaru</h5>
                    <h2 class="mb-0">Kebanggaan Sekolah Kami</h2>
                </div>
            </div>
        </div>
...
<section id="pengumuman" class="py-5 bg-white overflow-hidden">
    <div class="container py-4">
        <div class="row justify-content-center mb-5" data-aos="fade-up">
            <div class="col-lg-8 text-center">
                <div class="section-title">
                    <h5 class="text-maroon fw-bold text-uppercase mb-2">Pusat Informasi</h5>
