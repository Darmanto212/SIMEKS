...
check_auth('admin');
$pageTitle = "Dashboard Admin - SIMEKS";
...
$admin = [
    'nama' => $_SESSION['master_data']['nama'] ?? $_SESSION['admin_data']['nama'] ?? 'Administrator',
    'role' => $_SESSION['master_data']['role'] ?? $_SESSION['admin_data']['role'] ?? 'Admin'
];
?>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="alert bg-white border-0 shadow-sm rounded-4 p-4 mb-4 animate__animated animate__fadeInDown">
                <div class="row align-items-center">
                    <div class="col-md-9">
                        <h3 class="fw-bold text-maroon">Selamat Datang, Admin! 🚀</h3>
                        <p class="text-muted mb-0">Kelola informasi kegiatan ekstrakurikuler SMAN 2 Sukatani melalui dashboard ini secara terpadu.</p>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 h-100">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="text-muted small mb-0 font-weight-bold">Total Siswa</h6>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 p-3 h-100">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="text-muted small mb-0 font-weight-bold">Total Ekskul</h6>
                                <h4 class="fw-bold mb-0"><?php echo $total_eskul; ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
